...
export const action = {
  ...
  clear_publish_msg: success => {
    return {
      type: success
        ? actionTypes.CLEAR_PUBLISH_SUCCESS_RESULT
        : actionTypes.CLEAR_PUBLISH_FAIL_RESULT,
      success
    };
  },
  ...
  edit_article: (id, articleName, linkName, content, tags) => {
    return {
      ...
      data: {id, articleName, linkName, content, tags}
    };
  },
  clear_result_msg: () => {
    return {
  ...
  edit_upload_info: (title, newFile, oldFile, tags, linkName, writer, id) => {
    return {
      ...
      data: {title, newFile, oldFile, tags, linkName, writer, id}
    };
  }
};
